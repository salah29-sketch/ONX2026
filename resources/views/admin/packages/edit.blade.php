        ...
        <form action="{{ route('admin.packages.update', $package) }}" method="POST">
            ...
            <div class="grid grid-cols-12 gap-4">
                ...
                <div class="col-span-12 mb-4 mb-3">
                    ...
                    <textarea name="features" rows="4" class=" @error('features') is-invalid @enderror" placeholder='["ميزة 1", "ميزة 2"]'>{{ old('features', $package->features ? json_encode($package->features, JSON_UNESCAPED_UNICODE) : '') }}</textarea>
                    <small class="text-muted">أدخل المميزات بصيغة مصفوفة JSON صالحة.</small>
